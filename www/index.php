...
<html lang="fr">
  <head>
    ...
    <link rel="canonical" href="https://ecoride-production-48f6.up.railway.app/">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://ecoride-production-48f6.up.railway.app/">
    ...
    <meta name="twitter:image" content="https://ecoride-production-48f6.up.railway.app/images/logo-ecoride.png">
      ...
      "@graph": [
        {
          "@type": "Organization",
          "name": "EcoRide",
          "url": "https://ecoride-production-48f6.up.railway.app",
          "logo": "https://ecoride-production-48f6.up.railway.app/images/logo-ecoride.png",
          "contactPoint": {
            "@type": "ContactPoint",
        ...
        },
        {
          ...
          "potentialAction": {
            ...
            "target": {
              "@type": "EntryPoint",
              "urlTemplate": "https://ecoride-production-48f6.up.railway.app/pages/covoiturage.php?depart={depart}&destination={destination}&date={date}"
            },
